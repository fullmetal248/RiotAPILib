...
class Item {
	 ...
	 * @param $tags
	 */
	public function __construct($colloq, $isConsumeOnFull, $isConsumed, $depth, $description, $effect, $from, $gold,
								$group, $isHideFromAll, $id, $image, $isInStore, $into, $maps, $name, $plaintext,
