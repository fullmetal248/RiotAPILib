...
class GetChampionMasteryTopChampions extends BaseEndPoint {
	/**
	...
	public function __construct($apiKey, $region, $playerId) {
		...
		$this->targetUrl = "https://${hostUrl}/championmastery/location/${platformId}/player/${playerId}/topchampions?api_key=${apiKey}";
	}
}